...
# @scenario('../features/login.feature', 'Verify User navigated to products page after successful login')
# def test_login():
#     pass

scenarios('../../../tests/featureslogin.feature')
...
#
#
# # @when(parsers.parse('User enters the {valid_invalid} username and password'))
# # def enter_credentials(driver, valid_invalid):
